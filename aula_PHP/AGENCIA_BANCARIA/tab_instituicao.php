...
<head>
    ...
    <title>Registro das Instituições Financeiras</title>
...
<body>
    <h1>Registro das Instituições Financeiras</h1>
    ...
    <nav>
        <ul>
            ...
            <li><a href="http://localhost/aula_PHP/AGENCIA_BANCARIA/manutencao.php"></a></li>
...
<?php
    ...
    $sql = "SELECT * FROM instituicaofinan";
    ...
    if (!$resultado) {
        ...
        echo '<th>Nome</th>';
        echo '<th>Número da Instituição</th>';
        echo '</tr>';
        echo '</thead>';
        echo '<tbody>';
        ...
        while ($linha = mysqli_fetch_assoc($resultado)) {
            echo '<tr>';
            echo '<td>' . htmlspecialchars($linha['idinstituicao']) . '</td>';
            echo '<td>' . htmlspecialchars($linha['nome']) . '</td>';
            echo '<td>' . htmlspecialchars($linha['numero_instituicao']) . '</td>';
            echo '</tr>';
        }
